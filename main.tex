...
% left side %
{
        ...
        \begin{itemize}
            ...
            {REACT NATIVE FREELANCER}
            {
                \begin{itemize}[topsep=0pt,itemsep=0pt,parsep=0pt,partopsep=0pt]
                    ...
                    \item \textbf{100+ downloads} on Playstore
    ...
    \csection{ACHIEVEMENTS}{\small
        \begin{itemize}[topsep=5pt,itemsep=0pt,parsep=0pt,partopsep=0pt]
            ...
            \item Accepted research paper based on \textbf{Facial Emotion Recognition} in \clink{\href{https://www.ic3conf.net}{\textbf{IC3-2022(IEEE)}}}.
        \end{itemize}
    }
} 
% end left side %
